...
| **5단계: 고난도 & 기출** | 1/15 ~ 1/16 | Gold 2 ~ Platinum 5 | 복합 최단거리, 위상정렬 | 19236(G2), 23290(G1), 5719(G1), 1948(P5) |
...
- [ ] [5719 - 거의 최단 경로](https://www.acmicpc.net/problem/5719) (G1) - **복합 다익스트라**
- [ ] [1948 - 임계경로](https://www.acmicpc.net/problem/1948) (P5) - **위상정렬 + 역추적**
...
- [ ] **위상 정렬**: 작업 순서나 의존 관계가 있는 DAG에서의 순서 결정 및 누적값 계산
